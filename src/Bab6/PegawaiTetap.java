...
public class PegawaiTetap extends Employee {
    ...
    public PegawaiTetap(String nama, int id, String jabatan,  int tahun, boolean istri, int anak){
        super(jabatan, tahun); 
        this.nama = nama;
        this.id = id;
        this.istri = istri;
    ...
    public void setTotalGaji(){
        totalgaji = super.getGaji()+super.getBonus()+super.getTunjangan()+tunjangananak+tunjanganistri;
    }
